...
fn sort_object_keys(obj: Map<String, Value>) -> Map<String, Value> {
    ...
    for (key, value) in obj {
        declare_field_order!(key, value, known, non_private, private; [
            ...
            24 => "examplestyle",
            25 => "assets",
            26 => "bin" => transform_value(value, sort_object_alphabetically),
            27 => "source",
            28 => "directories" => transform_with_key_order(value, &["lib", "bin", "man", "doc", "example", "test"]),
            29 => "workspaces",
            30 => "binary" => transform_with_key_order(value, &["module_name", "module_path", "remote_path", "package_name", "host"]),
            31 => "files" => transform_array(value, sort_array_unique),
            32 => "os",
            33 => "cpu",
            34 => "libc" => transform_array(value, sort_array_unique),
