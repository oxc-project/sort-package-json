...
## [0.0.16](https://github.com/oxc-project/sort-package-json/compare/v0.0.15...v0.0.16) - 2026-08-16

### Added

- [**breaking**] prepare for 1.0.0 ([#158](https://github.com/oxc-project/sort-package-json/pull/158))

## [0.0.15](https://github.com/oxc-project/sort-package-json/compare/v0.0.14...v0.0.15) - 2026-08-16

### Fixed

- sort devEngines descriptor fields ([#155](https://github.com/oxc-project/sort-package-json/pull/155))
...
- add wireit under betterScripts ([#132](https://github.com/oxc-project/sort-package-json/pull/132))

### Fixed

- top-level sort for jest, tshy, remarkConfig, and auto-changelog ([#138](https://github.com/oxc-project/sort-package-json/pull/138))
...
- preserve `files` array order for negation patterns ([#43](https://github.com/oxc-project/sort-package-json/pull/43))
