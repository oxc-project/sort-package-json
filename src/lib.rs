...
fn sort_object_keys(obj: Map<String, Value>) -> Map<String, Value> {
    ...
    for (key, value) in obj {
        declare_field_order!(key, value, known, non_private, private; [
            ...
            62 => "publishConfig" => transform_value(value, sort_object_alphabetically), // Must be next to `imports` and `exports`
            63 => "scripts",
            64 => "betterScripts",
            65 => "dependencies" => transform_value(value, sort_object_alphabetically), // dependency management
            ...
            75 => "husky" => transform_value(value, sort_object_recursive), // commit replated
            76 => "simple-git-hooks",
            77 => "pre-commit",
            78 => "lint-staged",
            79 => "nano-staged",
            80 => "commitlint" => transform_value(value, sort_object_recursive),
            81 => "napi" => transform_value(value, sort_object_alphabetically), // config
            82 => "l10n",
            83 => "contributes",
            84 => "activationEvents" => transform_array(value, sort_array_unique),
            85 => "extensionPack" => transform_array(value, sort_array_unique),
            86 => "extensionDependencies" => transform_array(value, sort_array_unique),
            87 => "extensionKind" => transform_array(value, sort_array_unique),
            88 => "flat",
            89 => "config" => transform_value(value, sort_object_alphabetically),
            90 => "nodemonConfig" => transform_value(value, sort_object_recursive),
            91 => "browserify" => transform_value(value, sort_object_recursive),
            92 => "babel" => transform_value(value, sort_object_recursive),
            93 => "browserslist",
            94 => "xo" => transform_value(value, sort_object_recursive),
            95 => "prettier" => transform_value(value, sort_object_recursive),
            96 => "eslintConfig" => transform_value(value, sort_object_recursive),
            97 => "eslintIgnore",
            98 => "npmpkgjsonlint",
            99 => "npmPackageJsonLintConfig",
            100 => "npmpackagejsonlint",
            101 => "release",
            102 => "remarkConfig" => transform_value(value, sort_object_recursive),
            103 => "stylelint" => transform_value(value, sort_object_recursive),
            104 => "ava" => transform_value(value, sort_object_recursive),
            105 => "jest" => transform_value(value, sort_object_recursive),
            106 => "jest-junit",
            107 => "jest-stare",
            108 => "mocha" => transform_value(value, sort_object_recursive),
            109 => "nyc" => transform_value(value, sort_object_recursive),
            110 => "c8" => transform_value(value, sort_object_recursive),
            111 => "tap",
            112 => "oclif" => transform_value(value, sort_object_recursive),
            113 => "languageName",
            114 => "preferGlobal",
            115 => "icon",
            116 => "badges",
